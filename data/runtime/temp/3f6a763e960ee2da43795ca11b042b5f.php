<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/system\web2.htm";i:1590216967;s:77:"D:\phpStudy\PHPTutorial\WWW\bjhd\application\admin\template\public\layout.htm";i:1590216964;s:74:"D:\phpStudy\PHPTutorial\WWW\bjhd\application\admin\template\system\bar.htm";i:1590216968;s:77:"D:\phpStudy\PHPTutorial\WWW\bjhd\application\admin\template\public\footer.htm";i:1590216964;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" id="handlepost" action="<?php echo U('System/web2'); ?>" enctype="multipart/form-data" name="form1">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    http://www.bjhd.cn/<input type="hidden" name="adminbasefile_old" value="<?php echo (isset($adminbasefile) && ($adminbasefile !== '')?$adminbasefile:'login'); ?>"><input id="adminbasefile" name="adminbasefile" value="<?php echo (isset($adminbasefile) && ($adminbasefile !== '')?$adminbasefile:'login'); ?>" type="text" data-site_url="http://www.bjhd.cn" onKeyUp="this.value=this.value.replace(/[^0-9a-zA-Z_-]/g,'');" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^0-9a-zA-Z_-]/g,''));" style="width: 80px;" />.php
