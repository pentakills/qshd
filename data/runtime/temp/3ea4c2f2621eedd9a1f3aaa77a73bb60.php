<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"./template/pc/lists_article.htm";i:1590217258;s:55:"D:\phpStudy\PHPTutorial\WWW\bjhd\template\pc\header.htm";i:1590217258;s:55:"D:\phpStudy\PHPTutorial\WWW\bjhd\template\pc\footer.htm";i:1590458653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
                    ...
                    <div class="news-item">
                      <div class="news-com">
                        <div class="news-together">
                          <div class="news-h"> <a  href="<?php echo $field['typeurl']; ?>" class="news-kind" title="<?php echo $field['typename']; ?>">【<?php echo $field['typename']; ?>】</a> <a  href="<?php echo $field['arcurl']; ?>" title=" <?php echo $field['title']; ?>"> <?php echo $field['title']; ?></a> </div>
                          <div class="date"><?php echo MyDate('Y-m-d',$field['add_time']); ?></div>
                        </div>
                        <div class="news-sum"><?php echo html_msubstr($field['seo_description'],0,180,true); ?></div>
                      </div>
                    </div>
                  </li>
