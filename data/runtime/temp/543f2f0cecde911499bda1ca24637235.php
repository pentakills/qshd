<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"./template/pc/view_product.htm";i:1590217257;s:55:"D:\phpStudy\PHPTutorial\WWW\bjhd\template\pc\header.htm";i:1590217258;s:55:"D:\phpStudy\PHPTutorial\WWW\bjhd\template\pc\footer.htm";i:1590458653;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
                ...
                <div class="rotatePicbox-tel">
                  <div class="imgSlideMain clearfix">
                    ...
                    <div class="navSlideBox">
                      <ul class="navSlide">
                        <ul>
                          <?php if(is_array($eyou['field']['image_list']) || $eyou['field']['image_list'] instanceof \think\Collection || $eyou['field']['image_list'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $eyou['field']['image_list'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $mod = ($e % 20 );$i= intval($key) + 1;?>
                ...
                <div class="product-detail-info">
                  <div class="product-detail-info-in">
                    <div class="prd_detInfo_con">
                      ...
                      <div class="img" > <img src="<?php echo $field['image_url']; ?>"/> </div>
                      <!--<div class="product-grayBox clearfix">
                        <div class="product-prices">
                        <?php if(is_array($eyou['field']['attr_list']) || $eyou['field']['attr_list'] instanceof \think\Collection || $eyou['field']['attr_list'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $eyou['field']['attr_list'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $mod = ($e % 2 );$i= intval($key) + 1;?>
    ...
    .info_tab .cur_tab a{
        cursor:auto;
                  ...
                  <div class="news-others">
                    <div class="pre-next" >
                  <div class="news-prev"><?php  $tagPrenext = new \think\template\taglib\eyou\TagPrenext; $_result = $tagPrenext->getPrenext("pre");if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( empty($__LIST__) ) : echo htmlspecialchars_decode("上一篇：没有了");else: $field = $__LIST__;$field["title"] = text_msubstr($field["title"], 0, 100, false);?> <a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>"> 上一篇：<?php echo $field['title']; ?> </a> <?php endif; else: echo htmlspecialchars_decode("上一篇：没有了");endif; ?></div>
                  <div class="news-next"><?php  $tagPrenext = new \think\template\taglib\eyou\TagPrenext; $_result = $tagPrenext->getPrenext("next");if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( empty($__LIST__) ) : echo htmlspecialchars_decode("下一篇：没有了");else: $field = $__LIST__;$field["title"] = text_msubstr($field["title"], 0, 100, false);?> <a href="<?php echo $field['arcurl']; ?>" title="<?php echo $field['title']; ?>"> 下一篇：<?php echo $field['title']; ?> </a> <?php endif; else: echo htmlspecialchars_decode("下一篇：没有了");endif; ?></div>
                    </div>
                  </div>
                </div>
              </div>
